...
// CONCATENATED MODULE: ./src/components/layout/Mycanans.tsx
...
/* harmony default export */ var Mycanans = (Mycanvas);
...
class _document_CustomDocument extends document_default.a {
  ...
  render() {
    return _document_jsx(next_document["Html"], null, _document_jsx(next_document["Head"], null), _document_jsx("body", null, _document_jsx(Mycanans, null), _document_jsx(next_document["Main"], this.props), _document_jsx(next_document["NextScript"], null)), _document_jsx("script", {
      src: `${publicPath}canvasStar.js`
    }), _document_jsx("script", {
